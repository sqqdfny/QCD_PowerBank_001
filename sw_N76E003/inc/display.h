...
#define LED_W_ON()    (set_P05)
#define LED_W_OFF()   (clr_P05)
#define LED_B_ON()    (set_P06)
#define LED_B_OFF()   (clr_P06)
#define LED_R_ON()    (set_P07)
#define LED_R_OFF()   (clr_P07)
