...
static  u8 keyShakeTime;             //消抖时间
static  u8 keyRepeatTime;            //连动时间
static  u8 doubleTime;               //双击判断时间
static  u8 keyTimeSecond;            //按键按下的时间(S)
static  enumKeyStatus keyStatus;     //按键状态
static  KEY_CALLBACK * pKeyCallback; //按键回调

enumKeyValue keyValue;              //当前键值
static  enumKeyValue keyValueDouble; //双击标记
//==========================================================
